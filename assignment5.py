...
plt.title('Weekly Active Users (WAU)', fontsize=20)
...
plt.title('Onboarding Completion Rate', fontsize=20)
plt.xlabel('Time (Months)', fontsize=20)
plt.ylabel('Completion Rate (%)', fontsize=20)
plt.ylim(0, 100)
plt.xticks(rotation=45)
plt.grid(True, linestyle='--', alpha=0.7)
plt.tight_layout()
...
plt.title('Time to Onboard', fontsize=20)
plt.xlabel('Time Buckets', fontsize=16)
...
plt.title('Funnel Analysis - Onboarding Steps', fontsize=20)
plt.xlabel('Onboarding Steps', fontsize=16)
plt.ylabel('Number of Users', fontsize=16)
plt.tight_layout()
...
plt.title('Customer Acquisition Cost (CAC)', fontsize=20)
plt.xlabel('Months', fontsize=16)
plt.ylabel('Cost in Dollars ($)', fontsize=16)
plt.xticks(rotation=45)
plt.grid(True, linestyle='--', alpha=0.7)
plt.tight_layout()
...
plt.title('Net Promoter Score (NPS)', fontsize=20)
plt.xlabel('Time (Quarters)', fontsize=16)
plt.ylabel('NPS Score', fontsize=16)
plt.ylim(-100, 100)
plt.grid(True, linestyle='--', alpha=0.7)
plt.tight_layout()
